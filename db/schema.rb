...
ActiveRecord::Schema.define(:version => 20120618082322) do
  ...
  create_table "minion_jobs", :force => true do |t|
    t.string   "action"
    t.datetime "run_at"
    t.datetime "created_at",                          :null => false
    t.datetime "updated_at",                          :null => false
    ...
    t.boolean  "is_unprocessable", :default => false
  end

  add_index "minion_jobs", ["item_id", "item_type"], :name => "index_minion_jobs_on_item_id_and_item_type"
  ...
  add_index "settings", ["permalink"], :name => "index_settings_on_permalink"
  ...
  create_table "uninterests", :force => true do |t|
    t.datetime "created_at",          :null => false
    t.datetime "updated_at",          :null => false
    t.integer  "user_id"
    t.integer  "uninterestable_id"
    t.string   "uninterestable_type"
  end

  add_index "uninterests", ["uninterestable_id", "uninterestable_type"], :name => "index_uninterests_on_uninterestable_id_and_uninterestable_type"
  add_index "uninterests", ["user_id"], :name => "index_uninterests_on_user_id"
  ...
  create_table "users", :force => true do |t|
    ...
    t.boolean  "enable_weekly_newsletter", :default => true
  end

  add_index "users", ["city_id"], :name => "index_users_on_city_id"
  add_index "users", ["email"], :name => "index_users_on_email"
  add_index "users", ["enable_weekly_newsletter"], :name => "index_users_on_enable_weekly_newsletter"
  ...
  add_index "watch_logs", ["user_id"], :name => "index_watch_logs_on_user_id"
